                        ...
                        <div class="col-md-6 col-sm-8">
                            <div class="right-header ">
                                <ul>
                                    ...
                                    <li><a href="checkout_product.php"><i class="fa fa-usd"></i>Thanh toán đơn hàng</a></li>
                                    <?php
                                    if(isset($_COOKIE['tendangnhap'])) {
                                        ...
                                        if ($result && mysqli_num_rows($result) > 0) {
                                            ...
                                            echo '<li><a style="color:#00FFFF; font-weight: 500; text-transform: uppercase;" href="">' . $_COOKIE['tendangnhap'] . '</a>
                                                    <ul><div class="logout">';
                                            if ($user['role'] == 'admin') {
                                                echo '
                                                <li><a href="admin/index.php"></i>Truy cập trang Admin</a> <br></li>
                                                ';
                                            }
                                            echo '
                                                <li><a href="changePass.php"></i>Đổi mật khẩu</a> <br></li>
                                                <li><a href="checkout_product.php">Thanh Toán</a><br></li>
                                                <li><a href="history_product.php">Đơn Hàng</a><br></li>
                                                <li><a href="mailbox.php">Hộp Thư</a><br></li>
                                        ...
                                        <li><a href="shopping-cart.php"><i class="fa fa-shopping-cart"></i>
                                            ...
                                            <ul class="drop-cart">
                                                ...
                                                <li class="checkout-btn text-center">
                                                    <a href="checkout_product.php">Kiểm tra giỏ hàng</a>
                                                </li>
