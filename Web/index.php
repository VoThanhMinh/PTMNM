...
<section class="slider-main-area">
            <div class="main-slider an-si">
                <div class="bend niceties preview-2 hm-ver-1">
                    <div id="ensign-nivoslider-2" class="slides">	
                        <img src="/Web/images/Women_Prefall24_Show_WW_HP_Loop_20240416_DI3.jpg" alt="" title="#slider-direction-3"  />
                        <img src="/Web/images/Women_Prefall24_Show_WW_HP_Loop_20240416_DI3.jpg" alt="" title="#slider-direction-1"  />
                    </div>
                    <!-- direction 1 -->
                    <div id="slider-direction-3" class="t-cn slider-direction Builder">
                        <div class="slide-all">
                            ...
                            <div class="layer-1">
                                <h2 class="title5">Louis Vuitton Voyager Show</h2>
                            </div>
                         
                            <div class="layer-2">
                                <h2 class="title6">Bộ sưu tập Pre-Fall 2024 dành cho Nữ</h2>
                            </div>
                          
                            <div class="layer-3">
                                <a class="min1" href="shop.php?id_category=1">Khám phá thêm
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="section-title" style="color: #000000;">
							<h3 style="color: #090909;">DANH MỤC SẢN PHẨM</h3>
        ...
        <div id="banner2"><!--banner2 baneer rồng -->
            <div class="box-left" >
                ...
                <a href="thucdon_2.php?id_sanpham=2"><button>Khám phá thêm</button><!--nút mua hàng --></a>
            </div>
        </div>
<!--------------------NEW ARRIVALS--------------------------- -->
    <!-- new-products section start -->
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="section-title">
							<h3 style="color: #090909;" >SẢN PHẨM BÁN CHẠY</h3>
...
#banner2 {/* banner rồng*/
    width: 100%;
    background-image :url("/Web/images/M_BC_Spring_Mar24_02_DI3.jpg");
...
#banner3 {/* banner lilywuyn*/
    width: 100%;
    background-image :url("/Web/images/1706103945422-homepagecorpoonedesktopnoparallaxe5jpg.jpg");
    background-size:cover;
